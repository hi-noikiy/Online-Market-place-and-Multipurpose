					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6">
							...
							<div class="freelance-container">
								...
								<a href="freelancer-detail.html" class="btn btn-freelance bt-1">View Detail</a>
							</div>
						</div>
							...
							<div class="freelance-container">
								<div class="freelance-box">
									...
									<div class="freelance-inner-box">
										...
										<div class="freelance-box-detail">
											<h4>Delores R. Williams matul</h4>
						...
						<div class="col-md-4 col-sm-6">
							<div class="freelance-container">
								<div class="freelance-box">
									<span class="freelance-status bg-primary">Busy</span>
									<h4 class="flc-rate">$17/hr</h4>
									<div class="freelance-inner-box">
										<div class="freelance-box-thumb">
											<img src="http://via.placeholder.com/180x180" class="img-responsive img-circle" alt="" />
						...
						<div class="col-md-4 col-sm-6">
							<div class="freelance-container">
								<div class="freelance-box">
									<span class="freelance-status bg-danger">No Available</span>
							...
							<div class="freelance-container">
								<div class="freelance-box">
									...
									<div class="freelance-inner-box">
										...
										<div class="freelance-box-detail">
											<h4>Ray D. Ramirez</h4>
											<span class="desination">Seo/Smo Expert</span>
										</div>
									</div>
									<div class="freelance-box-extra">
										<ul>
						...
						<div class="col-md-4 col-sm-6">
							<div class="freelance-container">
								<div class="freelance-box">
									<span class="freelance-status bg-warning">At Work</span>
									<h4 class="flc-rate">$20/hr</h4>
									<div class="freelance-inner-box">
										<div class="freelance-box-thumb">
											<img src="http://via.placeholder.com/180x180" class="img-responsive img-circle" alt="" />
										</div>
										<div class="freelance-box-detail">
											<h4>Maryellen G. Reeder</h4>
											<span class="desination">Content Writer</span>
										</div>
									</div>
									<div class="freelance-box-extra">
										<ul>
