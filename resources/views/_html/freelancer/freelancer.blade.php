...
@section('title', 'Freelancer|Find Freelancer') 
@section('content')
@php
    // foreach ($freelancers as $freelancers) {
    //    print($freelancers);
    //    echo '<br>';
    // }
    // exit();
...
{{-- <section class="inner-header-page">
    <div class="container">
        ...
        <h2>Hire The Best Freelancer</h2>
    ...
    <div class="container">
        <form class="bt-form" id="searchForm">
            ...
            <div class="col-md-12 col-sm-12">
                <button type="submit" class="btn btn-primary form-control">Search Your Freelancer</button>
            </div>
        </form>
    </div>
</section>
...
<section class="accordion">
    ...
    @include('_html.ajax.ajaxFreelancer')
        </div>
    </div>
