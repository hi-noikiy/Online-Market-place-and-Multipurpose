    ...
    <div class="section detail-desc">
        <div class="container white-shadow">
            ...
            <div class="row">
                ...
                @if($freelancer->gender)
                <div class="col-md-6 col-sm-6">
                    <div class="form-group">
                        <label for="">Gender</label>
                        <h6>{{$gender[$freelancer->gender]}}</h6>
                    </div>
                </div>
                @endif
                @if($freelancer->age)
        ...
        <div class="container">
            <div class="row bottom-mrg extra-mrg">
                ...
                <div class="col-md-6 col-sm-6">
                    <h6 for="">Your Birthdate</h6>
                      <input name="birtdate" type="date" id="birthdate" value="{{$freelancer->birthday}}" placeholder="Birth day" class="form-control">
            ...
            <div class="row bottom-mrg extra-mrg">
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <small>This is Will be shown as Your Job Title/ Designation</small>
                </div>
                        ...
                        <div class="dublicat-box">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <select class="form-control input-lg" name="skill[]">
                                        ...
                                        @php
                                            $skill=App\Skill::where('type',$user->user_type)->get();
                                        @endphp
                                        @if($skill)
            ...
            <div class="row bottom-mrg extra-mrg">
                <h2 class="detail-title">Add Language</h2>
                <div class="extra-field-box">
                    <div class="multi-box">
                        <div class="dublicat-box">
...
function editProfile() {
    $('#addForm').validator().on('submit', function(e) {
        if (e.isDefaultPrevented()) {
            ...
            $.ajax({
                type: "POST",
                url: baseUrl + "Freelancer/editProfile",
