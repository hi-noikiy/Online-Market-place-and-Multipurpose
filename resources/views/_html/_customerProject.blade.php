...
<section class="manage-company gray">
    <div class="container">
                        ...
                        <div class="filter-form">
                            <div class="input-group">
                                <span class="input-group-btn">
												<button type="button" class="btn btn-success" onclick="addProject()">Add New</button>
											</span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div id="projectList">
                @include('_html.ajax.customerProject')
            </div>
                    ...
                    <section class="full-detail" style="margin-top:2%;">
                        <div class="container col-md-12">
                            <div class="row bottom-mrg extra-mrg">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <select class="form-control input-lg" name="freelancerType" required>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <input type="number" class="form-control" id="jobPrice" name="jobPrice" placeholder="Job Price" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                    ...
                    <section class="full-detail" style="margin-top:2%;">
                        <div class="container col-md-12">
                            <div class="row bottom-mrg extra-mrg">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <select class="form-control input-lg" id="freelancerType" name="freelancerType" required>
                                    <option value="">Select Freelancer Type</option>
                                    <option value="1">Freelancer</option>
                                    <option value="2">Pro</option>
                                </select>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="editJobPrice" name="jobPrice" placeholder="Job Price" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
