@foreach ($data['jobHistory'] as $item)
<div class="brows-job-list">
    ...
    <div class="col-md-6 col-sm-5">
        <div class="brows-job-position">
            ...
            <p>
                <span>{{$item->user_name}}</span><span class="brows-job-sallery"><i class="fa fa-money"></i>{{'$'.$item->budget}}</span>
...
{{-- <span class="tg-themetag tg-featuretag">Active</span> --}} @endforeach {!! $data[ 'jobHistory']->links() !!}