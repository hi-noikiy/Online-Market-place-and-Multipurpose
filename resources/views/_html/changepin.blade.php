...
<div class="card col-md-5 col-sm-5 ">
    <form action="{{url('changepin')}}" method="POST" id="form">
        @csrf
        <div class="form-group">
            <label for="">Old PIN</label>
            <input type="password" class="form-control" name="old_password" placeholder="Old PIN">
        </div>
        <div class="form-group">
        ...
        <small style="diaplay:none" id="p">Password Doesn't match</small>
    </form>
