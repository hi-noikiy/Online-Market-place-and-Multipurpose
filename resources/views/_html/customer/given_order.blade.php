                ...
                <div class="tab-content tabs" id="home">
                    ...
                    <div role="tabpanel" class="tab-pane fade in active" id="Active">
                        <div class="item-click">
                            <article>
                                <div id="activeJob">
    @include('_html.ajax.ajaxCustomerActiveJob')
                                </div>
                            </article>
                        </div>
                    </div>
    ...
    @include('_html.ajax.ajaxPendingJob')
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="Complete">
                        <div class="item-click">
                            <article>
                                <div id="completeJob">
    @include('_html.ajax.ajaxCustomerCompleteJob')
                                </div>
                            </article>
                        </div>
                    </div>
    ...
    @include('_html.ajax.ajaxCancelJob')
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="Revision">
                        <div class="item-click">
                            <article>
                                <div id="revisionJob">
    @include('_html.ajax.ajaxCustomerRevisionJob')
                                </div>
                            </article>
                        </div>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="Dispute">
                        <div class="item-click">
                            <article>
                                <div id="disputeJob">
    @include('_html.ajax.ajaxCustomerDisputeJob')
                                </div>
                            </article>
                        </div>
