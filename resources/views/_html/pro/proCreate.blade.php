...
<form id="addForm">
    ...
    <div class="section detail-desc">
        <div class="container white-shadow">
            ...
            {{-- Message --}}
            <div class="alert" id="proMessage"></div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="form-group">
                        <input type="text" class="form-control" name="professionTitle" placeholder="Professional Title" required>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-sm-6">
                    <textarea class="form-control" name="note" placeholder="About Notes"></textarea>
                </div>
    ...
    {{-- Button --}}
    <div class="col-md-12">
        <button type="submit" class="btn btn-success btn-primary small-btn" onclick="createProfile()">Create Profile</button>
    </div>
...
@endsection
 @push('scripts')
<script type="text/javascript " src="{{asset( '_html/pages/pro.js')}} "></script>
