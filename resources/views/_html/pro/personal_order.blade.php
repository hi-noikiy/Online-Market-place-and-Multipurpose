    ...
    <div class="col-md-4 col-sm-4">
        <div class="card">
            <div class="card-body">
                ...
                @php
                    $completed_order=App\ProFreeOrder::where('freelancer_type',1)->where('freelancer_id',$freelancer->id)->where('status',1)->get();
                @endphp
    ...
    <div class="col-md-4 col-sm-4"> 
        <div class="card">
            <div class="card-body">
                ...
                @php
                    $completed_order=App\ProFreeOrder::where('freelancer_type',1)->where('freelancer_id',$freelancer->id)->where('status',0)->get();
                @endphp
