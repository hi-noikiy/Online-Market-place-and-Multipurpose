                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div style="padding-bottom:2%">
                            <button type="button" class="btn btn-primary" onclick="addCountry()">
                ...
                <div class="modal-content">
                    ...
                    <form role="form" data-toggle="validator" id="addForm">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success" onclick="saveCountry()">Save</button>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <form role="form" data-toggle="validator" id="updateForm">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success" onclick="updateCountry()">Update</button>
                            <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                        </div>
...
@endsection
 @push('scripts')
    ...
    <script src="{{asset('_admin/pages/country.js')}}"></script>
