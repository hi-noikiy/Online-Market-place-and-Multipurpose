                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="skills-table" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Sl</th>
                                        <th>Name</th>
                ...
                <div class="modal-content">
                    ...
                    <form role="form" data-toggle="validator" id="addForm">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success" onclick="saveSkill()">Save</button>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <form role="form" data-toggle="validator" id="updateForm">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success" onclick="updateSkill()">Update</button>
                            <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                        </div>
...
@endsection
 @push('scripts')
    ...
    <script src="{{asset('_admin/pages/skill.js')}}"></script>
